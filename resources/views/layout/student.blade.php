...
<head>
    ...
    <!-- Page Title Here -->
    <title>{{ env('APP_NAME') }} | Student Access</title>
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="color_2"
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="/guardian" class="brand-logo">
                <img class="logo- img-fluid rounded" src="{{ asset('assets/images/logo.jpg') }}" alt="">

                <div class="brand-title">
                    <h3 class="text-white mt-3 inline-block" style="line-height: 23px">Standard Student</h3>
                </div>
            </a>
                                ...
                                <div class="dropdown header-profile2">
                                    <a class="nav-link ms-0" href="javascript:void(0);" role="button"
                                        ...
                                        <div class="header-info2 d-flex align-items-center">
                                            ...
                                            <img src="{{ asset('assets/images/students/student.png') }}"
                                                alt="">
                                        </div>
                                    </a>
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header p-3">
                                                <ul class="d-flex align-items-center">
                                                    ...
                                                    <li class="ms-2">
                                                        <h4 class="mb-0">
                                                            {{ ucfirst($student->surname . ' ' . $student->firstname) }}
                                                        </h4>
                                                        <span>{{ $student->grade->class }}</span>
                                                    </li>
                                                </ul>
            ...
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="" href="#" aria-expanded="false">
                            ...
                            <span class="nav-text">E-libary</span>
                        </a>
                    </li>



                    <li><a class="" href="/parent_logout" aria-expanded="false">

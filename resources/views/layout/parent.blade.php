...
<head>
    ...
    <!-- Page Title Here -->
    <title>{{ env('APP_NAME') }} | Parent Access</title>
        ...
        <div class="nav-header">
            <a href="/guardian" class="brand-logo">
                ...
                <div class="brand-title">
                    <h3 class="text-white mt-3 inline-block" style="line-height: 23px">Standard Parent</h3>
                </div>
            </a>
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header p-3">
                                                <ul class="d-flex align-items-center">
                                                    ...
                                                    <li class="ms-2">
                                                        <h4 class="mb-0">{{ ucfirst($guardian->guardian_name) }}
                                                        </h4>
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a class="" href="/guardian" aria-expanded="false">

                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Add Content For: {{ $note->grade->class }}, {{ $note->subject->subject }}
                            ...
                            <table class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="mb-0"> Father Abrahm </h6>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown custom-dropdown float-end">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="/admin/student/28">Edit Note</a>
                                                    <a class="dropdown-item" href="/admin/student/28">Delete Note</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="dropdown custom-dropdown float-end">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <a class="dropdown-item" href="#">Add Note Content</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>

...
@section('page_title')
    @if ($edit)
        Edit Prospective Exam Questions
    @else
        Add Prospective Exam Questions
    @endif
@endsection
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ $edit ? 'Edit' : 'Add' }} Questions : {{ $exam->grade->class }},
                                {{ $exam->subject->subject }} </h4>
                        </div>
                        <div class="card-body">
                            @if ($edit)
                                <form action="/admin/prospective/update-question" method="post">@csrf
                                    <div class="row">
                            ...
                            @else
                                <form action="/admin/prospective/add-question" method="post">@csrf
                                    <div class="row">
                                        <div class="col-md-12 mt-3">
                                            <label>Question</label>
                                        ...
                                        <div class="col-md-3 mt-3">
                                            <label>Option A</label>
                                            <textarea name="option_a" class="form-control" id="editor2"> {!! old('option_a') !!} </textarea>
                                        </div>
                                        <div class="col-md-3 mt-3">
                                            <label>Option B</label>
                                            <textarea name="option_b" class="form-control" id="editor3"> {!! old('option_b') !!} </textarea>
                                        </div>
                                        <div class="col-md-3 mt-3">
                                            <label>Option C</label>
                                            <textarea name="option_c" class="form-control" id="editor4"> {!! old('option_c') !!} </textarea>
                                        </div>

                                        <div class="col-md-3 mt-3">
                                            <label>Option D</label>
                                            <textarea name="option_d" class="form-control" id="editor5"> {!! old('option_d') !!} </textarea>
                                        </div>

                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-12 tab-content">
                            <div id="sign-up" class="auth-form tab-pane fade show active  form-validation">
                                <form action="/student-login" method="post" >@csrf
                                    <div class="text-center mb-4">
                                        <h3 class="text-center mb-2 text-black">Student Access</h3>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label mb-2 fs-13 label-color font-w500">Student Username</label>
                                        <input type="text" class="form-control" name="username" value="{{ old('username') }}" placeholder="Joy" autocomplete="t4frm" >
                                        @error('username')
